...
public class AddProductPanel extends JPanel {
    ...
    public AddProductPanel(ClothingStore store, ListProductsPanel listProductsPanel) {
        this.store = store;
        ...
        // Add labeled fields
        add(UIUtils.createLabeledField("Nama:", nameField), createConstraints(0, 0));
        add(UIUtils.createLabeledField("Harga:", priceField), createConstraints(0, 1));
        add(UIUtils.createLabeledField("Size:", sizeComboBox), createConstraints(0, 2));
        add(UIUtils.createLabeledField("Warna:", colorField), createConstraints(0, 3));
        add(UIUtils.createLabeledField("Material:", materialField), createConstraints(0, 4));

        // Add product button
        JButton btnAddProduct = new JButton("Tambah Item");
        styleButton(btnAddProduct, new Color(0, 0, 139)); // Applying blue color to the button
        ...
        TitledBorder titledBorder = BorderFactory.createTitledBorder("Tambah Item Baru");
    ...
    private void addProduct() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Item Berhasil Ditambahkan!", "Success", JOptionPane.INFORMATION_MESSAGE);
